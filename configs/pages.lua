...
-- 黄页应用 - “黄页”分类信息板。帖子全服务器可见且持久保存；信息流显示
-- 所有人的帖子，“我的发布”显示发布者自己的。新帖子联系号码留空时，回退
-- 使用发布者本人的号码。
return {
    ListLimit            = 100,  -- most-recent posts returned to the feed 信息流返回的最近帖子数
    MaxPostsPerPlayer    = 15,   -- 每名玩家最多发布数
    ...
    MaxImages            = 3,    -- photos attachable to a post 每个帖子可附带的照片数
